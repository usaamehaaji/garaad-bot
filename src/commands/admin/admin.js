// =====================================================================
// AMARKA: ?admin (router) — Aqoon + Dhaqaale
// =====================================================================
...
module.exports = async function adminCommand(message, args) {
    ...
    switch (sub) {
        ...
        case 'give':
        case 'sii':
            return mamulCmd(message, ['give', ...args]);

        case 'take':
        case 'qaad':
            return mamulCmd(message, ['take', ...args]);

        case 'shield':
            return mamulCmd(message, ['shield', ...args]);

        case 'info':
        case 'check':
            return mamulCmd(message, ['info', ...args]);

        case 'users':
        case 'ulist':
            return mamulCmd(message, ['list', ...args]);

        case 'ereset':
            return mamulCmd(message, ['reset', ...args]);
